...
def draw_dense_reg(hm_size, joint, sigma, locref_stdev, mask_sigma, kpd):
    ...
    mask_gaussian = 1.0/mask_sigma * np.exp(- h / (2 * mask_sigma ** 2))  # gaussian mask
    mask_gaussian *= mask01 
        
    return heatmap, offset_map, mask01, mask_gaussian
