...
model = dict(
    ...
    teacher_config='configs/body/2d_kpt_sview_rgb_img/tokenpose/coco/teacher_hr32_coco_64x64.py',
    teacher_ckpt='teacher_chkpts/hrnet_w32_64x64_tokenpose_d12_h8.pth',
    keypoint_head=dict(
        type='DistilPoseHead',
        in_channels=256,
        ...
        loss_reg2hm=dict(type='Reg2HMLoss', use_target_weight=True, loss_weight=1., 
                         encoding='MSRA', unbiased_encoding=True, image_size=[64, 64],
                         heatmap_size=[16, 16]),
        tde_cfg=dict(
            feature_size=[16, 16],
            patch_size=[4,4],
