...
from .layers.pose_hrnet import PoseHighResolutionNet
# from rlepose.opt import opt 
# global_is_train = False
...
class RegressFlow(nn.Module):
    def __init__(self, norm_layer=nn.BatchNorm2d, **cfg):
        ...
        self.preact = PoseHighResolutionNet(cfg)
        # if opt.global_is_train:
        self.preact.init_weights(cfg['PRETRAINED'])
        ...
        self.feature_channel = {
            18: 512,
            34: 512,
            50: 12288,    # if resolution = 32x32   here shoulde be：  50：2048  !!!!!!!!
            101: 2048,
            152: 2048
        }[cfg['NUM_LAYERS']]
